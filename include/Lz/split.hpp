...
// class split_iterable final : public detail::basic_iterable<detail::split_iterator<Iterator, S, Iterator2, S2>,
...
//     LZ_CONSTEXPR_CXX_14 split_iterable(Iterator begin, S end, Iterator2 begin2, S2 end2) :
...
// template<class Iterable, class Iterable2>
// LZ_NODISCARD LZ_CONSTEXPR_CXX_14 regular_splitter<iter_t<Iterable>, iter_t<Iterable2>>
...
// using string_splitter =
//     split_iterable<iter_t<Iterable>, sentinel_t<Iterable>, detail::c_string_iterator<const CharT*>, default_sentinel>;

// template<class Iterable, class CharT>
// LZ_NODISCARD LZ_CONSTEXPR_CXX_14 string_splitter<Iterable, CharT> split(Iterable&& iterable, const CharT* delimiter) {
...
// LZ_NODISCARD LZ_CONSTEXPR_CXX_17 basic_string_view<val_t<Iterator>> to_string_view(const basic_iterable<Iterator, S>& view) {
