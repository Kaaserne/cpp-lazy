 ...
 *     iterable is at least bidirectional and does not have a sentinel. Otherwise it will return a default_sentinel. Its input
 ...
 *     always be forward. It returns a default_sentinel. Example:
 * ```cpp
 * std::vector<int> vec = { 1, 2, 3, 4 };
