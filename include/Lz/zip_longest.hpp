...
//  *
//  * @details Zip iterator that zips multiple iterators, except the difference beteween zip_longest and zip is that zip longest
//  stops
...
//  * lz::detail::optional contains most of the basic funcitonality std::optional does. This iterator is a forward iterator if one
//  of
