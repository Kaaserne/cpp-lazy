...
// class cartesian_product_iterable {
...
//     template<class... Is>
//     LZ_CONSTEXPR_CXX_14 cartesian_product_iterable(Is&&... iterables) : _iterables(std::forward<Iterables>(iterables)...) {
//     }

//     LZ_NODISCARD LZ_CONSTEXPR_CXX_14 iterator begin() {
//         constexpr auto is = make_index_sequence<sizeof...(Iterables)>();
//         return { begin_tuple(_iterables, is), begin_tuple(_iterables, is), end_tuple(_iterables, is) };
//     }

//     template<class I = iterator>
//     LZ_NODISCARD LZ_CONSTEXPR_CXX_14 enable_if<is_bidi<I>::value, iterator> end() {
//         constexpr auto is = make_index_sequence<sizeof...(Iterables)>();
