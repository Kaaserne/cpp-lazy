...
//     template<class F = Func>
//     LZ_CONSTEXPR_CXX_20 enable_if<!std::is_default_constructible<F>::value, func_container> make_default() = delete;

//     template<class F = Func>
//     LZ_CONSTEXPR_CXX_20 enable_if<std::is_default_constructible<F>::value, func_container> make_default() {
//         return {};
//     }
